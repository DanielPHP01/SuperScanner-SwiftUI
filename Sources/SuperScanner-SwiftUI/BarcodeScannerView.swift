...
public struct BarcodeScannerView: UIViewControllerRepresentable {
    ...
    public class ScannerViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate {
        ...
        func handleBarcodeObservation(_ observation: VNBarcodeObservation) {
            ...
            if centerBoxLayer.path!.contains(barcodeBounds.origin) && centerBoxLayer.path!.contains(CGPoint(x: barcodeBounds.maxX, y: barcodeBounds.maxY)) {
                lastScanDate = Date()
